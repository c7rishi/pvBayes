...
function_name <- "Simulation_20230818a.R"

N_total_rep <- 200
n_task_simul <- 20

model <- "poisson_indep__zip_indep"
lambda_true <- c(1.2, 1.5, 1.7, 2.5, 3.5)
sig_col <- "1"
sig_row <- "45"
n_chains <- 2
...
## Pattern
## Simulation.R {lambda_true} {sig_col} {sig_row} {mod} {n_chains}
...
#   as.vector() %>%
#   writeLines("/projects/academic/chakrab2/xinweihu/output/pvbayes_simulation/command_line.txt")
settings$sbatchR_txt
