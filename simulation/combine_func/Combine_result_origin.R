...
# file_names <- list.files(path = "D:/Documents/UB/Research/Code/drug_safety_bayesian/simulation/res20230517",
#                          pattern = "\\.RDS",
#                          full.names = TRUE)

file_names <- list.files(path = "D:/Documents/UB/Research/Code/CCR/Download/simulation_result_20230518/temp",
                         pattern = "\\.RDS",
                         full.names = TRUE)
