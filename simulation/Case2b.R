...
tb_summary_2b <- tb_summary
tb_summary_2b$case <- "Weak"

tb_summary <- rbind(tb_summary_2a, tb_summary_2b)
...
tiff("D:/Documents/UB/Research/Code/pvBayes/simulation/Case2.tiff",
